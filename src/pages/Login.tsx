    ...
    <div className="flex h-screen w-full items-center justify-center bg-space-dark text-[#E0E0E0]">
      ...
      <div className="z-10 w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl">
          ...
          <p className="text-gray-400 text-center text-sm mb-8">Sign in to access your secure files</p>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            Don't have an account? <Link to="/register" className="text-[#00F0FF] hover:underline">Register</Link>
          </div>
        </div>
      </div>
    </div>
